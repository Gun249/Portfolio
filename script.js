...
const translations = {
    ...
    th: {
        ...
        aboutText: "สวัสดีครับ ผมชื่อ<b>กันต์ธร ศิริเจริญวัฒน์ (ชื่อเล่น: กันต์)</b>  <br>ปัจจุบันเป็นนักศึกษาชั้นปีที่ 4 ที่มหาวิทยาลัยกรุงเทพ สาขาวิทยาการคอมพิวเตอร์ คณะเทคโนโลยีสารสนเทศและนวัตกรรม <br>ผมสนใจด้าน <b>Backend Developer</b> โดยเฉพาะการออกแบบ API และการจัดการฐานข้อมูล และผมต้องการเรียนรู้และใช้ Machine Learning เพื่อสร้างเครื่องมือที่เป็นประโยชน์ โดยมีเป้าหมายที่จะเติบโตทั้งในเส้นทางของ <b>Backend Developer</b> และ <b> AI Engineer </b>",
        eduTitle: "การศึกษา",
